...
<section class="col-12 px-0">
        <div class="list-group bg-white my-3">
                <?php if (!empty($allCategoryDetailes)) :  ?>
                        <div class="list-group-item form-switch d-flex justify-content-center align-items-center flex-wrap p-2 px-md-3 py-md-2 border-0" style="min-height: 46px;">
                                ...
                                <label class="form-check-label" for="Category-Name" style="min-width: max-content;">همه</label>
                        </div>
                <?php
                endif;
